  ...
  unfluff.lazy = function (html, language) {
    return {
      ...
      rawTitle: function () {
        var doc;
        doc = getParsedDoc.call(this, html);
        return null != this.rawTitle_ ? this.rawTitle_ : this.rawTitle_ = extractor.rawTitle(doc);
      },
      date: function () {
        var doc;
        doc = getParsedDoc.call(this, html);
      ...
      all_links: function () {
        var doc;
        if (null != this.all_links_)
          return this.all_links_;
        doc = getCleanedDoc.call(this, html);
        return this.all_links_ = extractor.links(doc, doc('body'), this.lang());
      }
    };
  };
